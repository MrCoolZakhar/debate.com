...
| File | Purpose |
|------|---------|
| `src/lib/translations.ts` | Full EN/ES/FR/AR dictionary (794 keys per locale). New language block goes here. `Language` type is also here. |

...
const COMMITTEE_PRESETS = [
  ...
  { name: 'UN Environment Programme', acronym: 'UNEP', logoPath: '/logos/unep.svg', members: UNEP_MEMBERS },
...
const BUNDLES: Record<string, { label: string; acronym: string; logoPath?: string; members: string[] }> = {
  ...
  G20:        { label: 'G20',         acronym: 'G20',  logoPath: '/logos/g20.svg',           members: ['Argentina', 'Australia', 'Brazil', 'Canada', 'China', 'France', 'Germany', 'India', 'Indonesia', 'Italy', 'Japan', 'Mexico', 'South Korea', 'Russia', 'Saudi Arabia', 'South Africa', 'Turkey', 'United Kingdom', 'United States'] },

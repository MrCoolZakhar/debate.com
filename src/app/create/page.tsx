...
const COMMITTEE_PRESETS = [
  { name: 'UN Security Council', acronym: 'UNSC', logoPath: '/logos/un.png', members: UNSC_MEMBERS },
  ...
  { name: 'G20', acronym: 'G20', logoPath: '/logos/g20.png', members: ['Argentina','Australia','Brazil','Canada','China','France','Germany','India','Indonesia','Italy','Japan','Mexico','South Korea','Russia','Saudi Arabia','South Africa','Turkey','United Kingdom','United States'] },

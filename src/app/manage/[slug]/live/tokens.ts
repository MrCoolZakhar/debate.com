// ─────────────────────────────────────────────────────────────────────────────
// Local palette for the live-status surface.
//
// Everything here exists because a token in `neu.tsx` does not pass a contrast
// check on this page, and `neu.tsx` is a SHARED surface another workstream is
// actively editing — so it is fixed here, locally, rather than globally.
//

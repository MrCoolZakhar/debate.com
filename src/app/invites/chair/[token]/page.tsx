            ...
            <>
              ...
              <div className="mt-5">
                ...
                <p className="text-sm mb-6" style={{ color: '#6B5F52', fontFamily: OUTFIT, lineHeight: 1.55 }}>
                  You&apos;ve been invited to chair <strong style={{ color: NEU.ink }}>{invite!.committee_name}</strong> at{' '}
                  <strong style={{ color: NEU.ink }}>{invite!.conference_name}</strong>. Accepting adds this conference to your Gavelling account.
                </p>

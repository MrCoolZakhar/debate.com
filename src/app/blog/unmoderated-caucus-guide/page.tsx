  ...
  return (
    <>
      ...
      >
        ...
        <p>Any delegate can raise a placard and propose: "I move for an unmoderated caucus of [duration]." Some conferences require a stated purpose; others do not. The motion requires a simple majority to pass. There is no speakers list, no amendment. It either passes or fails.</p>
        ...
        <ul>
          ...
          <li><strong>Start a working paper.</strong> Even a rough outline (three operative clauses on a shared doc or notepad) gives your bloc something to rally around.</li>
          <li><strong>Approach opposing blocs.</strong> Real diplomacy happens here. You will not move an opposing bloc during formal debate. One short conversation in an unmod can shift the whole dynamic.</li>

  ...
  return (
    <>
      ...
      >
        ...
        <p>Most MUN conferences award in the following tiers:</p>
        <ul>
        ...
        <p>Most experienced chairs assess delegates across five dimensions:</p>
        <ul>
          ...
          <li><strong>Diplomacy:</strong> Can the delegate build relationships with opposing blocs? Do they treat all delegations respectfully, not just their allies?</li>
        ...
        <p>Chairs also notice what delegates do wrong. Common award-killers:</p>
        <ul>

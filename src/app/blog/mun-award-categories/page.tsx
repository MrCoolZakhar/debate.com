  ...
  return (
    <>
      ...
      >
        ...
        <p>It is a serious position and the committees are often noticeably more collaborative. What it costs is a motivational structure that many delegates, especially newer ones, genuinely respond to, and a comparable result to put on a university application. If you are choosing conferences, this is a real axis of difference. You can see how individual conferences describe themselves on <Link href="/conferences/explore">the conference directory</Link>.</p>

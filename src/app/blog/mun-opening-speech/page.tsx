  ...
  return (
    <>
      ...
      >
        ...
        <p>Your opening speech on the General Speakers List is your first, and sometimes only, chance to define your delegation&apos;s position and attract bloc members. Most delegates waste it with a generic country summary. This guide shows you how to write one that actually moves the room. For more finished models, see our <Link href="/blog/mun-speech-examples">MUN speech examples</Link>.</p>
        ...
        <p>State what your country supports. Be specific. Reference real votes, treaties, or domestic policy if possible. Your <Link href="/blog/mun-position-paper-guide">position paper</Link> should already hold them. This is what delegates will remember and react to.</p>

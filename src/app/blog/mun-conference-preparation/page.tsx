  ...
  return (
    <>
      ...
      >
        ...
        <ul>
          <li>Look up your country&apos;s general foreign policy orientation: is it typically aligned with Western blocs, the G77 or BRICS, or does it tend to take independent positions?</li>
        ...
        <ul>
          ...
          <li><strong>Draft a rough position statement:</strong> three sentences saying what the problem is, what your country believes and what the committee should do.</li>
        </ul>
        ...
        <ul>
          <li>What majority is required for substantive versus procedural votes?</li>

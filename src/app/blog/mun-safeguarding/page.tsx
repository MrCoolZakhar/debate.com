  ...
  return (
    <>
      ...
      >
        ...
        <p>The same applies to your tools. Whatever holds your applications and rosters, know where the data sits, who can see it, and what happens to it afterwards. Gavelling keeps applications in one queue with per-section permissions for the organising team, and runs no third-party analytics or tracking (organisers see only anonymous page-view counts for their conference page, with no cookies and no IP addresses stored), so there is no third party building a profile of your delegates. Ask the same question of anything else you use.</p>

  ...
  return (
    <>
      ...
      >
        ...
        <p>Two or three of those days beat one long one. A break every 45 to 60 minutes is not generosity; it is what keeps the last hour usable. And finish when you said you would, because a delegate at home has a family expecting them, not a hotel.</p>
        ...
        <TableWrap>
          <table>
            ...
            <tbody>
              <tr><td>Video and audio</td><td>Breakout rooms, screen share, a stable call with 40 or more participants, host controls</td><td>Free tiers with time limits, or no breakouts</td></tr>
              ...
              <tr><td>Documents</td><td>Live collaborative drafting, sharing to the whole committee, a version history that survives</td><td>Papers passed as screenshots in chat</td></tr>
        ...
        <Callout>Whatever you choose, choose it for every committee. Running two committees on different stacks doubles your support load, halves the usefulness of your training, and guarantees that the one chair who improvised is the one with a problem at 10:40 on Saturday.</Callout>
        ...
        <p>One rule solves half the remaining problems: everyone is muted by default and unmutes to speak when recognised, including in caucus. It sounds heavy-handed, but it is the reason online committees are audible at all.</p>

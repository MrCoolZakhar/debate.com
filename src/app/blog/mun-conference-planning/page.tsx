...
export default function Article() {
  return (
    <>
      ...
      >
        <p>Planning a Model UN conference from scratch is genuinely hard. You are simultaneously managing academic content, event logistics, people management, and technology, often with a team of students who have never done it before. This guide gives you a realistic, chronological plan for pulling it off well.</p>
        ...
        <ul>
          <li><strong>Book your venue.</strong> School cafeterias, library halls, university rooms, whatever you can secure. You need one room per committee plus a space for opening and closing ceremonies.</li>
          ...
          <li><strong>Form your secretariat.</strong> At minimum: a Secretary-General (overall lead), a Director-General (operations), committee directors for each committee, and a communications/registration lead.</li>
        ...
        <ul>
          ...
          <li><strong>Open delegate registration.</strong> Set a registration fee if needed to cover venue and catering costs.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Assign countries.</strong> Each registered school or team gets a list of countries across committees. Try to give schools country assignments that match their team's experience level.</li>

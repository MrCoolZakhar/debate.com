  ...
  return (
    <>
      ...
      >
        ...
        <H2>Points</H2>
        <p>Points are interruptions made by delegates to address procedural issues or seek information. They take priority over motions and can be raised at any time except while another delegate has the floor (with one exception).</p>
        <ul>

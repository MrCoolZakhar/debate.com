  ...
  return (
    <>
      ...
      >
        ...
        <p>Whether a resolution passes depends on the voting threshold set by your rules of procedure:</p>
        <ul>
        ...
        <p>Friendly amendments (agreed to by the main sponsor) do not require a separate vote. They are incorporated into the draft before voting begins.</p>

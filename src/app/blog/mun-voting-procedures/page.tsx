  ...
  return (
    <>
      ...
      >
        ...
        <ul>
          <li><strong>Simple majority:</strong> The most common threshold for General Assembly-style committees. More In Favour votes than Against votes, among those present and voting (abstentions do not count).</li>
          <li><strong>Supermajority (two-thirds):</strong> Required for important questions in the GA. Two-thirds of present-and-voting delegations must vote In Favour. The Security Council works differently: see the veto section below.</li>
        ...
        <p>If amendments have been submitted to a draft resolution, they are voted on first. The order varies: a common rule is reverse order of submission (most recently submitted first), and UN practice votes first on the amendment furthest removed in substance from the original. If an amendment passes, the resolution text is updated before the final vote. If the amendment fails, the original text stands.</p>
        ...
        <p>Security Council simulations follow different rules. A substantive resolution needs at least nine of the fifteen members voting In Favour, and no veto. The P5 (US, UK, France, Russia, China) hold veto power: any single P5 member voting Against defeats a resolution, regardless of the total vote count. Abstentions by P5 members do not constitute a veto. This creates fundamentally different bloc dynamics compared to GA committees.</p>

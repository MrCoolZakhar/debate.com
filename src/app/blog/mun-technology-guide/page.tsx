      ...
      <div style={s.page}>
        <div style={s.wrap}>
          ...
          <article style={s.article}>
            ...
            <p style={s.p}>Gavelling's built-in chat lets chairs send messages directly to individual delegates and to all delegates, which is useful for distributing document links, announcing unmod times, or privately flagging procedure issues without interrupting formal debate.</p>

            <h2 style={s.h2}>Projection and Display</h2>
            <p style={s.p}>In large committee rooms, projecting the current speakers list and timer is a significant quality-of-life improvement for delegates. Gavelling's chair view can be mirrored to a projector, so delegates at the back of a 100-person room can see exactly who is speaking and how much time remains. This reduces the number of times delegates ask the chair "who is next?"</p>

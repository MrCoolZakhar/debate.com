        ...
        <div style={s.wrap}>
          ...
          <article style={s.article}>
            ...
            <ul style={s.ul}>
              ...
              <li style={s.li}><strong>A stable video conferencing platform.</strong> Zoom is standard at most online conferences. Microsoft Teams and Google Meet are alternatives. Have a backup plan for your backup plan, because these platforms still fail.</li>
            ...
            <ul style={s.ul}>
              ...
              <li style={s.li}><strong>Call on delegates by name, not just country.</strong> This keeps people alert, since anyone might be next.</li>

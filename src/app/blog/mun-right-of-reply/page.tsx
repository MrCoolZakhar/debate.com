  ...
  return (
    <>
      ...
      >
        ...
        <p>In real UN practice, the right of reply is invoked when a delegation believes its honour, name, or the integrity of its government has been impugned. MUN simulations follow the same principle, though application varies by conference.</p>
        ...
        <ul>
          ...
          <li>You want an extra speaking slot but missed the GSL</li>
        </ul>
        ...
        <p>After the offending speech ends and before the next speaker begins, raise your placard and state: "Point of personal privilege, the delegation of [Country] requests the right of reply." Some conferences require a written request submitted to the dais. The chair will rule on whether to grant it.</p>

  ...
  return (
    <>
      ...
      >
        ...
        <p>When two strong blocs emerge with competing working papers, you face a choice: compete or merge. Competing is only viable if you are confident your bloc can deliver the necessary majority without the other group's votes. If you cannot, merger negotiations are always worth attempting.</p>
        <p>In merger talks: identify the three clauses each side cares most about and try to preserve all six in the merged document. Accept that some language will be weakened. Agree on primary sponsor order upfront.</p>

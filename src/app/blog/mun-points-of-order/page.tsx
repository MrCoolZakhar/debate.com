  ...
  return (
    <>
      ...
      >
        ...
        <p>The point of order is one of the most misused procedures in Model UN. Raised correctly, it demonstrates procedural mastery and earns chairs' respect. Raised incorrectly, or too frequently, it signals inexperience, irritates the room, and wastes everyone's time. This guide clarifies exactly what a point of order is, when it applies, and how both delegates and chairs should handle it.</p>
        ...
        <p>State the specific rule being violated if you know it. A point of order that cites a specific rule is significantly more credible than a vague objection.</p>

  ...
  return (
    <>
      ...
      >
        ...
        <p>The single biggest differentiator in MUN is preparation. Delegates who know their country's position cold can spend committee time on strategy instead of scrambling to figure out what they believe.</p>
        <ul>
        ...
        <ul>
          ...
          <li><strong>Find common ground first.</strong> Even opposing blocs usually agree on the problem. Start there and work outward to solutions.</li>
        ...
        <p>A common mistake is raising your placard for every speaking slot regardless of what you have to say. Chairs and fellow delegates notice when speeches are filler. Say something substantive, or yield your time.</p>
        <ul>
        ...
        <p>Points of information, points of order, and motions are procedural tools. Used well, they show command of the room. Used poorly, they signal desperation or inexperience.</p>
        <ul>

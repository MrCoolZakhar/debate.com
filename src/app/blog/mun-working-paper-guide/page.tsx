    ...
    <>
      ...
      >
        ...
        <ul>
          ...
          <li><strong>Draft resolution:</strong> A formally formatted document submitted to the dais. Must meet the conference's minimum sponsor and signatory requirements. Can be debated and voted on once introduced.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Four to eight operative clauses:</strong> the specific actions you want the committee to take</li>
        </ul>
        ...
        <p>When two blocs have competing working papers, the chair will often encourage merging rather than allowing both to be introduced. Merging is a negotiation: each side has clauses they will not give up, and clauses they can compromise on.</p>
        ...
        <p>After introduction, the draft resolution is available for amendment and formal debate. The working paper phase is over. You are now in the final push to pass your resolution.</p>
      </ArticleLayout>
    </>
  );
}

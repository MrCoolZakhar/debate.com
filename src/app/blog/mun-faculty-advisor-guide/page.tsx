  ...
  return (
    <>
      ...
      >
        ...
        <ul>
          <li><strong>Run practice sessions before the conference.</strong> Even two or three mock committee sessions dramatically improve first-timers' performance and confidence.</li>
        ...
        <p>Not all conferences are appropriate for all experience levels. Evaluate conferences on:</p>
        <ul>
          ...
          <li><strong>Cost:</strong> Registration fees, travel, and accommodation add up. Budget carefully and apply for any available financial aid early.</li>

...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    'A complete guide for faculty advisors running a Model UN programme: preparing students, choosing conferences, reviewing position papers, and supporting delegates at the conference.',
  path: '/blog/mun-faculty-advisor-guide',
  ogDescription:
    'Everything faculty advisors need to run a successful MUN programme.',
  type: 'article',
});
...
export default function Article() {
  return (
    <>
      ...
      >
        <p>Faculty advisors are the backbone of every successful school MUN programme. You are simultaneously coach, logistics coordinator, welfare officer, and sometimes the only adult in the building who knows what a moderated caucus is. This guide covers the full advisor role: from <Link href="/blog/start-mun-club">building a programme from scratch</Link> to supporting experienced delegates at competitive conferences.</p>
        ...
        <p>If you are starting a new MUN club, start small and build deliberately. A first-year programme with ten well-prepared students attending one local conference will build more sustainable momentum than a thirty-student programme thrown at a major national conference unprepared.</p>
        <ul>
          ...
          <li><strong>Teach procedure explicitly.</strong> Most students will not learn rules of procedure from a document alone. Run mock votes, practise points of order, and simulate caucus proposals during club meetings.</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Lunch debrief:</strong> What happened in the morning session? What is the plan for the afternoon? Keep this constructive. It is a strategy session, not a critique session.</li>

      ...
      <div style={s.page}>
        <div style={s.wrap}>
          ...
          <article style={s.article}>
            ...
            <p style={s.p}>Ask delegates to raise their placards if they wish to speak during the caucus. Call on them in the order they raised, recording each name. In a large committee this happens fast — have your co-chair or director assistant capture names while you manage the room. Software like Gavelling handles this automatically, letting co-chairs add speakers to the caucus queue without interrupting the chair.</p>

  ...
  return (
    <>
      <style>{`
        ...
        .gavel-enter { animation: gavelEntrance 1.1s cubic-bezier(0.34,1.56,0.64,1) both 0.1s; }
      `}</style>
      ...
      <div className="min-h-screen bg-[#EDE7D8] flex flex-col relative overflow-x-hidden">
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <nav className="relative z-20 flex items-center justify-between px-8 md:px-14 py-5">
            ...
            <div className="flex items-center gap-8">
              ...
              <button
                ...
                className="bg-[#1B3828] hover:bg-[#2A5A3C] active:scale-[0.98] text-[#EED98A] font-bold text-sm px-5 py-2.5 rounded-xl transition-all">
                Start Committee
              </button>
            </div>
          </nav>
          ...
          {/* Hero — two columns */}
          <section className="relative z-10 flex items-center min-h-[88vh] px-8 md:px-14 gap-8">
            ...
            <div className="flex-1 flex flex-col justify-center max-w-2xl">
              ...
              {/* Join input */}
              <div className="hero-5 flex flex-col gap-2 w-fit">
            ...
            <div className="flex-1 flex items-center justify-center">
              <img
                ...
                alt="Gavelling gavel and olive wreath"
                className="gavel-enter w-[480px] h-[480px] md:w-[560px] md:h-[560px] object-contain select-none"
                style={{
                  mixBlendMode: 'multiply',

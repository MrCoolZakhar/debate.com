...
export const ENTRY_TYPES: {
  ...
  { key: 'delegate',    label: 'Delegate',    Icon: User,      emoji: 'Busts in silhouette', bleedIcon: UserRound,      bleedRotate: -6, accent: '#2A5A3C', border: '#C8BEA8',               discBg: 'linear-gradient(145deg, #2F6242 0%, #1B3828 100%)',              discGlyph: '#EED98A', chipInk: '#245234', chipBg: '#1B3828', chipText: '#EED98A', chipBorder: 'rgba(238,217,138,0.4)' },

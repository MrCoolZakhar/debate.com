      ...
      <button
        ...
        style={{
          ...
          ...(variant === 'well' ? {
            ...
            boxShadow: open
              ? 'inset 3px 3px 8px rgba(27,56,40,0.14), inset -3px -3px 8px rgba(255,255,255,0.7), 0 0 0 3px rgba(27,56,40,0.13)'
              : 'inset 3px 3px 8px rgba(27,56,40,0.14), inset -3px -3px 8px rgba(255,255,255,0.7)',
          } : null),
        }}
      >

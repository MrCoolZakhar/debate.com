...
function getSteps(language: string, docs: DocLabels): TutorialStep[] {
  return [
    ...
    },
    {
      ...
      bubbleText: pick(language, {
        ar: <>الأول في القائمة جاهز. انقر على <strong>بدء</strong> لإعطاء الكلمة إلى {G('أول مندوب')}!</>,
        fr: <>Le premier de la liste est prêt. Cliquez sur <strong>DÉMARRER</strong> pour donner la parole au {G('premier délégué')} !</>,
        es: <>El primero de la lista ya está listo. Haz clic en <strong>INICIAR</strong> para dar la palabra al {G('primer delegado')}.</>,
        en: <>The first on the list is ready. Click <strong>START</strong> to give the {G('first delegate')} the floor!</>,
      }),

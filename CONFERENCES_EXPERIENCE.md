...
- **Current (24 Sep 2026), supersedes the audit notes below:** a 9-step wizard. 1 Your conference (full name, acronym, logo, banner, dates or TBD, with a live preview of the conference card; `IdentityStep.tsx`), 2 format, 3 level, 4 where, 5 expected delegates, 6 committees (the dashboard's `CommitteeEditorModal` in draft mode: nothing is written until Create), 7 description + socials, 8 intent, 9 review. No fee and no visibility question; the conference starts private.

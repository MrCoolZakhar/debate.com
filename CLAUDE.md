...
- **The owner's taste board (25 Sep 2026, 67 votes on real specimens; the board is https://claude.ai/artifact/9CDYVLCgb7h8apgaDPEyad). Overall direction, in the owner's words: "love airbnb!!! literally copy them".** Read these before designing anything; they are votes, not guesses.
  ...
  - **Open questions (asked 25 Sep 2026, answer pending) where these votes contradict older rules in this section:** capital-letter button labels (the forest capitals pill got a no), the big-icon-over-word button rule, "green and white blocks" (forest bands and forest cards got a no), the QuorumRings half-circle gauges, and `GavelLoader`. Until answered, do not spread the contradicted older patterns to new surfaces.

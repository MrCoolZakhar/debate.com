...
- **The owner's taste board (25 Sep 2026, 67 votes on real specimens; the board is https://claude.ai/artifact/9CDYVLCgb7h8apgaDPEyad). Overall direction, in the owner's words: "love airbnb!!! literally copy them".** Read these before designing anything; they are votes, not guesses.
  ...
  - **Superseded by board two:** "EVERY button label is UPPERCASE" above no longer holds for new work: the liked button is sentence case. Apply only when a surface is being redesigned; do not mass-rewrite labels unasked.
  - **Still open (was):** button style (capital labels vs sentence case, shape, colour) is being decided on a second taste board of designs the site has never used; the QuorumRings gauges and `GavelLoader` are also still unconfirmed. Do not restyle any surface toward this board until the owner has seen the second board.

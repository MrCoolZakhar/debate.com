...
- **The owner's taste board (25 Sep 2026, 67 votes on real specimens; the board is https://claude.ai/artifact/9CDYVLCgb7h8apgaDPEyad). Overall direction, in the owner's words: "love airbnb!!! literally copy them".** Read these before designing anything; they are votes, not guesses.
  ...
  - **Buttons stay UPPERCASE (owner, 25 Sep 2026).** Every button label stays UPPERCASE: the owner overruled board two's sentence case. Board two's shape and colour notes (rounded rectangle, forest gradient, ink outline for second actions) still apply.
  - **Still open (was):** the QuorumRings gauges and `GavelLoader` are still unconfirmed. Button case is settled (UPPERCASE, above).
